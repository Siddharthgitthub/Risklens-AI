  ...
  return (
    <div className="min-h-screen text-white p-10 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* ===== TITLE ===== */}
        <h1 className="text-5xl font-bold mb-6 text-center bg-gradient-to-r from-purple-400 via-fuchsia-500 to-indigo-500 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(168,85,247,0.6)]">
          ...
          <button
            onClick={async () => {
              try {
                ...
                a.href = url;
                a.download = "RiskLens_AI_Report.pdf";
                a.click();
              } catch {
                alert("Report download failed");
              }
            }}
            className="px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:scale-105 transition shadow-lg"
          >
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-12">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-purple-500/20 shadow-[0_0_40px_rgba(124,58,237,0.25)] p-6 rounded-2xl">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-purple-500/20 shadow-[0_0_40px_rgba(124,58,237,0.25)] p-6 rounded-2xl">
            <MonteCarloChart
              data={{ median: safeMedian, best: safeBest, worst: safeWorst }}
            />
          </div>
